...
#Read in GPS data
with open(r'C:\Users\FS6GSOps\Desktop\TLE_Script\APID02310.csv') as csvfile:
...
ephem=open(r'C:\Users\FS6GSOps\Desktop\TLE_Script\ephemeris.e','w')
...
#Access Satellite
satellite = scenario.Children.Item("FalconSAT-6")
satellite2 = satellite.QueryInterface(STKObjects.IAgSatellite)
...
#exProp.Filename=r'C:\Users\C21Joshua.Block\Desktop\Capstone\TLE Script\ephemeris.e'
exProp.Propagate()
